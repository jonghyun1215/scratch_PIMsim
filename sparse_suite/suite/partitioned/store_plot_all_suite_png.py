...
for file_name in os.listdir(folder_path):
    if file_name.endswith('.mtx'):  # 확장자가 .mtx인 파일만 처리
        ...
        png_file_path = 'png/' + os.path.splitext(mtx_file_path)[0] + '.png'
        ...
        plt.savefig(png_file_path, dpi=300)  # 고해상도 PNG로 저장
        plt.close()  # 플롯 닫기
        
        print(f"Saved: {png_file_path}")

print("All .mtx files have been processed and saved as .png.")
